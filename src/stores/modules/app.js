...
export default {
  ...
  state: () => ({
    ...
    apiUpload: import.meta.env.VITE_APP_API_UPLOAD,
  ...
  actions: {
    ...
    toggleDarkMode(arg) {
      if (arg != undefined) this.darkMode = arg
    ...
    closeSideBar(arg) {
      ...
      this.sidebar.withoutAnimation = arg
    },
    toggleDevice(arg) {
      this.device = arg
    },
    setComponentLoaded(arg) {
      this.componentLoaded = arg
    },
    setLeftDrawer(arg) {
      this.leftDrawer = arg ? arg : false
    },
    setSearch(arg) {
      this.search = arg
    },
