<template>
  ...
  <q-dialog v-model="isDialog" :maximized="isMaximized">
    <fake-component :componentLoad="component" />
  </q-dialog>
</template>
<script>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return {
      ...
      async onRouterLink(val) {
        // console.log(val)
        if (val.meta.dialog && $q.platform.is.mobile) {
          $store.commit('app/LEFT_DRAWER', false)
          // component.value = val.meta.component
          // component.value = val.children[0].component
          component.value = val.meta.component === null || val.meta.component === undefined ? val.component : val.children[val.meta.component].component
